...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle args) {
        ...
        takipci = (TextView)view.findViewById(R.id.takipçi);
    ...
    private class PostTweet extends AsyncTask<String, String, String> {
        @Override
            protected void onPreExecute() {
                ...
                progress.setMessage("Tweet atılıyor...");
           ...
           protected String doInBackground(String... args) {
	            ...
	            builder.setOAuthConsumerKey(pref.getString("API_key", ""));
	            builder.setOAuthConsumerSecret(pref.getString("API_secret", ""));
	            ...
	            try {
                    ...
                    {
					twitter4j.Status response = twitter.updateStatus(tweetText +" ayhankorkmaz.net- via @ayhankorkmaz_ ");
           ...
           protected void onPostExecute(String res) {
        	   if(res != null){
               progress.dismiss();
               Toast.makeText(getActivity(), "Tweet başarı ile gönderildi", Toast.LENGTH_SHORT).show();
               tDialog.dismiss();
        	   }else{
        		   progress.dismiss();
                   Toast.makeText(getActivity(), "Tweet gönderilirken hata oluştu", Toast.LENGTH_SHORT).show();
                   tDialog.dismiss();
        	   }
    ...
    private class LoadProfile extends AsyncTask<String, String, Bitmap> {
        @Override
            protected void onPreExecute() {
                super.onPreExecute();
                progress = new ProgressDialog(getActivity());
                progress.setMessage("Profil alınıyor...");
                progress.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                progress.setIndeterminate(true);
                progress.show();
          ...
          return bitmap;
           ...
           protected void onPostExecute(Bitmap image) {
               ...
               prof_name.setText("Merhaba " +pref.getString("NAME", ""));
               takipci.setText("Takipci Sayisi:                 "+pref.getString("takipci", ""));
